...
def main():
    ...
    # Subparser for posting log
    log_parser = subparsers.add_parser("post_log")
    log_parser.add_argument("message", type=str, help="Log message to send to the master controller")
    ...
    set_difficulty_parser = subparsers.add_parser("set_difficulty")
    ...
    trans_parser = subparsers.add_parser("post_transaction")
    ...
    if args.command == "post_log":
        post_log(args.message)
    elif args.command == "add_node":
        add_node(args.node)
    elif args.command == "set_difficulty":
